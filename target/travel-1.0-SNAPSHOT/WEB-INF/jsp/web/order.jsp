<%-- Document : tour-place Created on : 11 Sep 2021, 15:09:55 Author : trang --%>
...
<html>
    ...
    <head>
        ...
        <!-- Modernizr JS -->
        <script src="../template/../template/js/modernizr-2.6.2.min.js"></script>
        <!-- FOR IE9 below -->
        <!--[if lt IE 9]>
...
<![endif]-->
    ...
    <body>
        <c:url value="/hotel/order-${room.id}" var="action" />
        ...
        <div id="page">
            ...
            <aside id="colorlib-hero">
                <div class="flexslider">
                    <ul class="slides">
                        <li style="background-image: url(../template/images/cover-img-4.jpg);">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-field">
                                                        ...
                                                        <form:input type="date" path="checkout"
                                                                    class="form-control datetimepicker-input"
            ...
            <div id="colorlib-subscribe" style="background-image: url(../template/images/img_bg_2.jpg);"
                    ...
                    <div class="row row-pb-md">
                        ...
                        <div class="col-md-2">
                            ...
                            <ul class="colorlib-footer-links">
                                ...
                                <li><a href="#">How These 5 People Found The Path to Their Dream
                                        Trip</a></li>
                                <li><a href="#">A Definitive Guide to the Best Dining and Drinking
                                        Venues in the City</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p>
                                ...
                                reserved | This template is Brought To You By <i class="icon-heart2"
                                                                                 aria-hidden="true"></i> by <a href="https://colorlib.com"
                                                                                 target="_blank">Code-Projects.Org</a>
